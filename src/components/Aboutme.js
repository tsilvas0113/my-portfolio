    ...
    return (
        <section className="about-me" id="about">
            ...
            <div className="about-me__body">
                ...
                <p>I didn't start realizing how much I liked programming until I started studying for my computer science degree. After spending several years in college, I made the decision that my dream job would be as a software engineer. And although I adore all things related to software development, becoming a web developer is where most of my interests lie.</p>
            </div>
